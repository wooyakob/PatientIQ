...
def main():
    ...
    for patient_id in patient_ids:
        ...
        try:
            ...
            print("  1. Fetching wearable data (30 days)...")
            wearable_data = get_wearable_data_by_patient(patient_id=patient_id, days=30)
            ...
            print("  2. Getting patient condition...")
            ...
            try:
                ...
                if conditions and len(conditions) > 0:
                    condition = conditions[0].get(
                        "condition_name", condition_map.get(patient_id, "Unknown")
                    )
                else:
            ...
            print("  3. Vectorizing wearable trends...")
            vector_result = vectorize_wearable_trends(
                wearable_data=wearable_data, patient_condition=condition
            )
            ...
            print("  4. Storing vector in Couchbase...")
            ...
            try:
                ...
                collection.upsert("trend_summary", trend_doc)
