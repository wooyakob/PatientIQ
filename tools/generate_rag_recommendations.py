...
def generate_rag_recommendations(
    ...
    research_papers: Optional[list[dict]] = None
) -> dict:
    """
    ...
    if research_papers and len(research_papers) > 0:
        ...
        research_context = "No research papers available. Base recommendations on clinical guidelines."
...
Return your response as a JSON array of recommendation objects."""
    ...
    try:
        ...
        response = llm.chat.completions.create(
            model="gpt-4o",
            messages=[
                {"role": "system", "content": "You are a clinical decision support AI specializing in pulmonology."},
