...
- Prompt loading from medical_researcher.yaml
...
def run_medical_research(
    ...
    try:
        # Log workflow start
        if research_span:
            research_span.log(agentc.span.SystemContent(
        ...
        if research_span:
            ...
            step_span.log(agentc.span.ToolCallContent(
        ...
        if research_span:
            ...
            step_span.log(agentc.span.ToolResultContent(
                tool_result={
            ...
            step_span.log(agentc.span.KeyValueContent(
                key="patient_condition",
                value=f"{patient.get('patient_name')} - {condition}"
            ))
        ...
        if research_span:
            ...
            search_span.log(agentc.span.ToolCallContent(
        ...
        if research_span:
            search_span.log(agentc.span.ToolResultContent(
                tool_result={
            ...
            search_span.log(agentc.span.KeyValueContent(
                key="papers_found",
                value=len(papers)
            ))
        ...
        if research_span:
            llm_span.log(agentc.span.KeyValueContent(
                key="summary_length",
                value=len(response)
            ))
        ...
        if research_span:
            research_span.log(agentc.span.KeyValueContent(
