...
This Agent can view Public messages and announcements and nudge a Doctor to read when its important and related to them. The Agent can also respond to Private messages when a Doctor is unavailable providing a contact or method to reach them in an emergency.
...
https://docs.couchbase.com/ai/build/tools-prompts-hub.html
https://couchbaselabs.github.io/agent-catalog/
https://github.com/couchbaselabs/agent-catalog
https://github.com/couchbaselabs/agent-catalog/tree/master/examples/with_langgraph
